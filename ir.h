...
typedef enum{START,END,NOP,CALL,RET,DEC,PRINT,INP,ARR_GET,ARR_ASSIGN,BRANCH,JUMP,ASSIGN,INC,EQUATE,
UNARY,PLUS,MINUS,MUL,DIV,AND,OR,LT,LE,GT,GE,EQ,NE,PUSH,POP,POP2} Operator;
